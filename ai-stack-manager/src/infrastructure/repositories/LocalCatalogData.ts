 ...
 * @description Static catalog data used by LocalRegistry as a built-in fallback.
 * Kept in a separate module so the data can be imported by tests directly and
 * LocalRegistry can be constructed with custom data for isolated unit testing.
 */
...
const agentPackages: Package[] = [
  // ── ORCHESTRATOR ──
  Package.create({
    id: 'agent-orchestrator', name: 'zm1-orchestrator', displayName: 'ZM1 Orquestrador',
    ...
    type: PackageType.Agent, version: '1.0.0', tags: ['core', 'workflow', 'ai'], author: 'Itaú Engineering',
    files: [{ relativePath: '.github/agents/zm1-orchestrator.agent.md', content: '---\nname: zm1-orchestrator\ndescription: >\n  🧠 Orquestrador Mestre — control plane determinístico.\ntools:\n  - read\n  - search\n  - web\n  - agent\n  - todo\n  - vscode/askQuestions\nagents:\n  - planner\n  - code-architect\n  - backend-specialist\n  - frontend-specialist\n  - database-specialist\n  - devops-specialist\n  - test-engineer\n  - code-reviewer\nuser-invocable: true\n---\n\n# ZM1-Orchestrator\n\nOrquestrador mestre do sistema multi-agent.\n' }],
    ...
    agentMeta: { category: AgentCategory.Orchestrator, tools: ['read', 'search', 'web', 'agent', 'todo', 'vscode/askQuestions'], delegatesTo: ['planner', 'code-architect', 'backend-specialist', 'frontend-specialist', 'database-specialist', 'devops-specialist', 'test-engineer', 'code-reviewer'], workflowPhase: 'ALL (TRIAGE → DELIVER → REMEMBER)', userInvocable: true, relatedSkills: ['skill-api-design', 'skill-security', 'skill-testing-strategy'] },
  }),

  // ── PLANNER ──
  Package.create({
    id: 'agent-planner', name: 'planner', displayName: 'Planejador Estratégico',
    ...
    type: PackageType.Agent, version: '1.0.0', tags: ['core', 'workflow', 'architecture'], author: 'Itaú Engineering',
    files: [{ relativePath: '.github/agents/planner.agent.md', content: '---\nname: planner\ndescription: >\n  📐 Planejador Estratégico — decompõe pedidos em todo graphs.\ntools:\n  - read\n  - search\n  - web\n  - todo\nagents: []\nuser-invocable: false\n---\n\n# Planner\n\nPlanejador estratégico do sistema multi-agent.\n' }],
    agentMeta: { category: AgentCategory.Planner, tools: ['read', 'search', 'web', 'todo'], delegatesTo: [], workflowPhase: 'PLAN', userInvocable: false },
  }),

  // ── ARCHITECT ──
  Package.create({
    id: 'agent-code-architect', name: 'code-architect', displayName: 'Arquiteto de Software',
    description: 'Arquiteto de software — define fronteiras, contratos, trade-offs e decisões arquiteturais (ADRs).',
    type: PackageType.Agent, version: '1.0.0', tags: ['architecture', 'core'], author: 'Itaú Engineering',
    files: [{ relativePath: '.github/agents/code-architect.agent.md', content: '---\nname: code-architect\ndescription: >\n  🏛️ Arquiteto de Software.\ntools:\n  - read\n  - search\n  - web\nagents: []\nuser-invocable: false\n---\n\n# Code Architect\n' }],
    agentMeta: { category: AgentCategory.Specialist, tools: ['read', 'search', 'web'], delegatesTo: [], workflowPhase: 'DESIGN', userInvocable: false, relatedSkills: ['skill-api-design'] },
  }),

  // ── BACKEND ──
  Package.create({
    id: 'agent-backend', name: 'backend-specialist', displayName: 'Especialista Backend',
    description: 'Especialista Backend — APIs, microsserviços, regras de negócio, integrações, autenticação e caching.',
    type: PackageType.Agent, version: '1.0.0', tags: ['backend', 'specialist', 'core'], author: 'Itaú Engineering',
    files: [{ relativePath: '.github/agents/backend-specialist.agent.md', content: '---\nname: backend-specialist\ndescription: >\n  ⚙️ Especialista Backend.\ntools:\n  - read\n  - edit\n  - execute\n  - search\nagents: []\nuser-invocable: false\n---\n\n# Backend Specialist\n' }],
    agentMeta: { category: AgentCategory.Specialist, tools: ['read', 'edit', 'execute', 'search'], delegatesTo: [], workflowPhase: 'EXECUTION', userInvocable: false, relatedSkills: ['skill-api-design', 'skill-security', 'skill-db-core'] },
  }),

  // ── FRONTEND ──
  Package.create({
    id: 'agent-frontend', name: 'frontend-specialist', displayName: 'Especialista Frontend',
    description: 'Especialista Frontend — React, Next.js, CSS, acessibilidade (WCAG) e otimização de performance web.',
    type: PackageType.Agent, version: '1.0.0', tags: ['frontend', 'specialist'], author: 'Itaú Engineering',
    files: [{ relativePath: '.github/agents/frontend-specialist.agent.md', content: '---\nname: frontend-specialist\ndescription: >\n  🎨 Especialista Frontend.\ntools:\n  - read\n  - edit\n  - execute\n  - search\nagents: []\nuser-invocable: false\n---\n\n# Frontend Specialist\n' }],
    agentMeta: { category: AgentCategory.Specialist, tools: ['read', 'edit', 'execute', 'search'], delegatesTo: [], workflowPhase: 'EXECUTION', userInvocable: false, relatedSkills: ['skill-frontend-core'] },
  }),

  // ── DATABASE ──
  Package.create({
    id: 'agent-database', name: 'database-specialist', displayName: 'Especialista em Banco de Dados',
    description: 'Especialista DBA — PostgreSQL, DynamoDB, Redis, migrações, índices e otimização de queries.',
    type: PackageType.Agent, version: '1.0.0', tags: ['database', 'specialist'], author: 'Itaú Engineering',
    files: [{ relativePath: '.github/agents/database-specialist.agent.md', content: '---\nname: database-specialist\ndescription: >\n  🗄️ Especialista em Banco de Dados.\ntools:\n  - read\n  - edit\n  - search\nagents: []\nuser-invocable: false\n---\n\n# Database Specialist\n' }],
    agentMeta: { category: AgentCategory.Specialist, tools: ['read', 'edit', 'search'], delegatesTo: [], workflowPhase: 'EXECUTION', userInvocable: false, relatedSkills: ['skill-db-core'] },
  }),

  // ── DEVOPS ──
  Package.create({
    id: 'agent-devops', name: 'devops-specialist', displayName: 'Especialista DevOps',
    description: 'Especialista DevOps — CI/CD, Docker, Kubernetes, Terraform e automação de pipelines.',
    type: PackageType.Agent, version: '1.0.0', tags: ['devops', 'specialist', 'cloud'], author: 'Itaú Engineering',
    files: [{ relativePath: '.github/agents/devops-specialist.agent.md', content: '---\nname: devops-specialist\ndescription: >\n  🔧 Especialista DevOps.\ntools:\n  - read\n  - edit\n  - execute\n  - search\nagents: []\nuser-invocable: false\n---\n\n# DevOps Specialist\n' }],
    agentMeta: { category: AgentCategory.Specialist, tools: ['read', 'edit', 'execute', 'search'], delegatesTo: [], workflowPhase: 'EXECUTION', userInvocable: false, relatedSkills: ['skill-aws-core', 'skill-datadog-core'] },
  }),

  // ── TEST ENGINEER ──
  Package.create({
    id: 'agent-test-engineer', name: 'test-engineer', displayName: 'Engenheiro de Testes',
    description: 'Especialista em Testes — TDD, pirâmide de testes, estratégias de cobertura e validação funcional.',
    type: PackageType.Agent, version: '1.0.0', tags: ['testing', 'specialist'], author: 'Itaú Engineering',
    files: [{ relativePath: '.github/agents/test-engineer.agent.md', content: '---\nname: test-engineer\ndescription: >\n  🧪 Engenheiro de Testes.\ntools:\n  - read\n  - edit\n  - execute\n  - search\nagents: []\nuser-invocable: false\n---\n\n# Test Engineer\n' }],
    agentMeta: { category: AgentCategory.Guardian, tools: ['read', 'edit', 'execute', 'search'], delegatesTo: [], workflowPhase: 'VALIDATION', userInvocable: false, relatedSkills: ['skill-testing-strategy'] },
  }),

  // ── CODE REVIEWER ──
  Package.create({
    id: 'agent-code-reviewer', name: 'code-reviewer', displayName: 'Revisor de Código',
    description: 'Revisor crítico — análise de segurança, qualidade, performance e manutenibilidade.',
    type: PackageType.Agent, version: '1.0.0', tags: ['security', 'core'], author: 'Itaú Engineering',
    files: [{ relativePath: '.github/agents/code-reviewer.agent.md', content: '---\nname: code-reviewer\ndescription: >\n  🔍 Revisor Crítico.\ntools:\n  - read\n  - search\nagents: []\nuser-invocable: false\n---\n\n# Code Reviewer\n' }],
    agentMeta: { category: AgentCategory.Guardian, tools: ['read', 'search'], delegatesTo: [], workflowPhase: 'CRITIC', userInvocable: false, relatedSkills: ['skill-security'] },
  }),
];

// ─── Skills ───────────────────────────────────────────────────────────────────

const skillPackages: Package[] = [
...
const instructionPackages: Package[] = [
...
export const LOCAL_CATALOG_PACKAGES: readonly Package[] = Object.freeze([
  ...agentPackages,
  ...skillPackages,
  ...mcpPackages,
  ...instructionPackages,
...
export const LOCAL_CATALOG_BUNDLES: readonly Bundle[] = Object.freeze(bundleData);
