  ...
  private static agentPackages(): Package[] {
    return [
      ...
      Package.create({
        ...
        displayName: 'ZM1 Orchestrator',
        description: 'Master orchestrator — deterministic control plane for triage, routing, quality gates, delivery, and memory. Coordinates a network of 8 specialist agents through the OODA workflow.',
      ...
      Package.create({
        ...
        description: 'Strategic planner — decomposes ambiguous requests into actionable todo graphs with dependencies, priorities, and execution topology.',
        type: PackageType.Agent,
        version: '1.0.0',
      ...
      Package.create({
        ...
        description: 'Software architect — defines boundaries, contracts, trade-offs, and ADRs for structural decisions.',
        type: PackageType.Agent,
        version: '1.0.0',
      ...
      Package.create({
        ...
        description: 'Backend expert — APIs, microservices, business rules, integrations, auth, and application caching.',
        type: PackageType.Agent,
        version: '1.0.0',
      ...
      Package.create({
        ...
        description: 'Frontend expert — React, Next.js, CSS, accessibility (WCAG), and web performance optimization.',
        type: PackageType.Agent,
        version: '1.0.0',
      ...
      Package.create({
        ...
        description: 'DBA expert — PostgreSQL, DynamoDB, Redis, migrations, indexing, and query optimization.',
        type: PackageType.Agent,
        version: '1.0.0',
      ...
      Package.create({
        ...
        description: 'DevOps expert — CI/CD, Docker, Kubernetes, Terraform, and pipeline automation.',
        type: PackageType.Agent,
        version: '1.0.0',
      ...
      Package.create({
        ...
        description: 'Testing expert — TDD, test pyramid, coverage strategies, and validation.',
        type: PackageType.Agent,
        version: '1.0.0',
      ...
      Package.create({
        ...
        description: 'Critical reviewer — security, quality, performance, and maintainability analysis.',
        type: PackageType.Agent,
        version: '1.0.0',
        tags: ['security', 'core'],
        author: 'Itaú Engineering',
